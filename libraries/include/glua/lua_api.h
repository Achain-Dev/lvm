...
#define LVM_API_NO_ERROR 0
#define LVM_API_SIMPLE_ERROR 1
#define LVM_API_MEMORY_ERROR 2
#define LVM_API_LVM_ERROR 3
#define LVM_API_PARSER_ERROR 4
#define LVM_API_COMPILE_ERROR 5
#define LVM_API_LVM_LIMIT_OVER_ERROR 6
#define LVM_API_THROW_ERROR 7   // glua代码中主动抛出的错误
            ...
            class IGluaChainApi {
              public:
                ...
                */
                ...
                virtual std::shared_ptr<GluaModuleByteStream> get_bytestream_from_code(lua_State *L, const Code& code) = 0;
                /**
